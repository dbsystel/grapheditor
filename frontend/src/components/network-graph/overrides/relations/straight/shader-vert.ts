...
export default function getVertexShader({ arrowHead }: CreateEdgeClampedProgramOptions) {
...
void main() {
  ...
  float boundingBoxThickness = v_thickness;

  v_cpA = viewportSource;
  v_cpB = 0.5 * (viewportSource + viewportTarget) + unitNormal * a_direction;
