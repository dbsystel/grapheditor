...
api.register_blueprint(node_api, url_prefix="/api/v1/nodes")

api.register_blueprint(relation_api, url_prefix="/api/v1/relations")

if config.dev_mode:
    api.register_blueprint(dev_api, url_prefix="/api/v1/dev")

api.register_blueprint(login_api, url_prefix="/api/v1/session")

api.register_blueprint(database_api, url_prefix="/api/v1/databases")

api.register_blueprint(meta_api, url_prefix="/api/v1/meta")

api.register_blueprint(query_api, url_prefix="/api/v1/query")

api.register_blueprint(perspective_api, url_prefix="/api/v1/perspectives")

api.register_blueprint(style_api, url_prefix="/api/v1/styles")

api.register_blueprint(
    context_menu_api, url_prefix="/api/v1/context-menu/actions"
)

api.register_blueprint(info_api, url_prefix="/api/v1/info")
...
def route_requires_connection():
    ...
    return request.method.lower() != "options" and (
        not request.path
        or any(request.path.startswith(r) for r in routes_with_connection)
    )
